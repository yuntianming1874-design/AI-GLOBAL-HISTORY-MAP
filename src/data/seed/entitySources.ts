...
export const ENTITY_SOURCES: HistoricalSource[] = [
  /* ── c-tang（唐朝）── */
  {
    ...
    factKey: "span",
    sourceTitle: "《旧唐书》",
    sourceUrl: "https://zh.wikisource.org/wiki/舊唐書",
    sourceType: "primary",
    authorityLevel: "A",
  ...
  },
  {
    ...
    factKey: "span",
    sourceTitle: "《新唐书》",
    sourceUrl: "https://zh.wikisource.org/wiki/新唐書",
    sourceType: "primary",
    authorityLevel: "A",
    reviewStatus: "verified",
    reviewedAt: "2026-08-16",
  ...
  },
  {
    ...
    sourceUrl: "https://www.cambridge.org/core/books/cambridge-history-of-china/411C9876D063F2F730E0E0E35B3FE83B",
  ...
  /* ── c-abbasid（阿拔斯王朝）── */
  {
    ...
    sourceUrl: "https://zh.wikipedia.org/wiki/歷代先知與帝王史",
    sourceType: "primary",
    authorityLevel: "A",
    reviewStatus: "verified",
    reviewedAt: "2026-08-16",
  ...
  },
  {
    ...
    sourceUrl: "https://books.google.ht/books?id=lZnDCwAAQBAJ",
    sourceType: "university_press",
    authorityLevel: "B",
    reviewStatus: "verified",
    reviewedAt: "2026-08-16",
  ...
  /* ── e-751-talas（怛罗斯之战）── */
  {
    ...
    sourceUrl: "https://zh.wikisource.org/wiki/資治通鑑/卷216",
    sourceType: "primary",
    authorityLevel: "A",
    reviewStatus: "verified",
    reviewedAt: "2026-08-16",
  ...
  },
  {
    ...
    sourceUrl: "https://baike.baidu.com/item/中国通史/3137831",
    sourceType: "university_press",
    authorityLevel: "B",
    reviewStatus: "verified",
    reviewedAt: "2026-08-16",
  ...
  /* ── p-abu-muslim（阿布·穆斯林）── */
  {
    ...
    sourceUrl: "https://books.google.pt/books?id=1_03AAAAIAAJ",
    sourceType: "university_press",
    authorityLevel: "B",
    reviewStatus: "verified",
    reviewedAt: "2026-08-16",
  ...
  },
  {
    ...
    note: "755 年为曼苏尔所杀的记载；人工核对未找到可靠公开链接，保持 pending。",
  },
  ...
  /* ── loc-talas（怛罗斯）── */
  {
    ...
    factKey: "location",
    sourceTitle: "《新唐书·地理志》",
    sourceUrl: "https://zh.wikisource.org/zh-hans/新唐書/卷040",
    sourceType: "primary",
    authorityLevel: "A",
    reviewStatus: "verified",
    reviewedAt: "2026-08-16",
  ...
  },
  {
    ...
    authorityLevel: "B",
    reviewStatus: "pending",
    note: "怛逻斯河谷（今哈萨克斯坦–吉尔吉斯斯坦交界）的现代定位依据；人工核对未找到可靠公开链接，保持 pending。",
  },
];
