...
const DICT = {
  ...
  "world.pageTitle": { en: "World by Year", zh: "按年看世界同期" },
  "world.pageSubtitle": { en: "Same year, different regions — from curated data only.", zh: "同一年，世界不同地区发生了什么？仅来自现有结构化资料。" },
  "world.yearPicker": { en: "Year picker", zh: "年份选择" },
  "world.pickYear": { en: "Pick a year:", zh: "选择年份：" },
  "home.worldYearLink": { en: "See the world year by year →", zh: "按年看世界同期 →" },
  ...
  "complete.title": { en: "Journey Complete", zh: "旅程完成" },
  "complete.subtitle": { en: "You explored “{title}”.", zh: "你完成了「{title}」。" },
  "complete.statSteps": { en: "Steps", zh: "历史节点" },
  "complete.statEvents": { en: "Events", zh: "事件" },
  "complete.statPeople": { en: "People", zh: "人物" },
  "complete.statCivs": { en: "Civilizations", zh: "文明" },
  "complete.statLocations": { en: "Locations", zh: "地点" },
  "complete.memories": { en: "Core memories", zh: "核心记忆" },
  "complete.nextTitle": { en: "What next?", zh: "接下来" },
  "complete.reExplore": { en: "Re-explore", zh: "重新探索" },
  "complete.backToAtlas": { en: "Back to World Atlas", zh: "回到世界地图" },
  "complete.moreJourneys": { en: "More journeys", zh: "继续一个旅程" },
  "complete.recall": { en: "Recall quiz", zh: "开始复习" },
  "complete.askAI": { en: "Ask AI", zh: "问 AI" },
